...
- (void)viewDidLoad {
    ...
    webview = [[UIWebViewClass alloc] initWithFrame: bounds];
    ...
    [webview scrollView].panGestureRecognizer.allowedTouchTypes = @[ @(UITouchTypeIndirect) ];
...
-(void)pressesEnded:(NSSet<UIPress *> *)presses withEvent:(UIPressesEvent *)event
{
    ...
    else if (presses.anyObject.type == UIPressTypeSelect)
    {
        ...
        [webview stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"document.elementFromPoint(%i, %i).click()", (int)point.x, (int)point.y]];
    }
    ...
    else if (presses.anyObject.type == UIPressTypePlayPause)
    {
        ...
        UIAlertAction *okAction = [UIAlertAction
                                   ...
                                   {
                                       [webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://%@", temporaryURL]]]];
                                       temporaryURL = nil;
                                   }];
